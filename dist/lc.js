...
di.applyOperation(op2);})();include('/home/zippy/lc-qcad/tools.js');(function(){var before=Date.now();var doc=getDocument();var di=getDocumentInterface();var offsLay=doc.queryLayer('Offs');if(isNull(offsLay)){offsLay=AddLayer('Offs','Green');}
...
break;}}}}}
di.applyOperation(op);qDebug((Date.now()-before)/1e3,'s');})();include('/home/zippy/lc-qcad/tools.js');(function(){var before=Date.now();var doc=getDocument();var di=getDocumentInterface();function Node(pos,h,w){this.obj=null;this.pos=pos;this.h=h;this.w=w;}
...
di.applyOperation(op);qDebug((Date.now()-before)/1e3,'s');})();include('/home/zippy/lc-qcad/tools.js');function GetCX(pts){var n=pts.length;var s=0;for(var i=1;i<n;i++){if(pts[i].y<pts[s].y){s=i;}}
