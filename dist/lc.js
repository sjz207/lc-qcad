...
else{break;}}}};exports.kdTree=kdTree;exports.BinaryHeap=BinaryHeap;}));var cfg={"paper-size":[250,1000],"paper-padding":10,"engraving-layer-name":"Gravur","cutting-layer-name":"Schnitt","cutting-width":0.15,"packing-padding":3,"same-sized-objects-dist":2,"gap-width":0.5,"gap-min-dist":25};(function(){var doc=getDocument();var di=getDocumentInterface();var entities=doc.queryAllEntities();var layA=doc.queryLayer(cfg['cutting-layer-name']);if(isNull(layA)){layA=addLayer(cfg['cutting-layer-name'],'Black');}
